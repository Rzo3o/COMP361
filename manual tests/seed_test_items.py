...
This inserts a Sword, Helmet, Chestplate, Leggings, 3 Bread, and 2 Health Potions into slot 1's inventory.
...
c.execute(
    "INSERT OR IGNORE INTO inventory (session_id, item_id, quantity) VALUES (1, 4, 1)"
)
c.execute(
    "INSERT OR IGNORE INTO inventory (session_id, item_id, quantity) VALUES (1, 5, 1)"
)
c.execute(
    "INSERT OR IGNORE INTO inventory (session_id, item_id, quantity) VALUES (1, 6, 1)"
)
...
print(
    ...
    - Iron Helmet x1 (head armor, +5 DEF)
    - Chain Chestplate x1 (chest armor, +8 DEF)
    - Leather Leggings x1 (leg armor, +3 DEF)
